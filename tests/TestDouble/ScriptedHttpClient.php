...
namespace Setono\Quickpay\TestDouble;
 ...
 *
 * Records every dispatched request in $sentRequests so assertions can run after the fact. This is a
 * fake, not a mock — the right tool for "given this URL was hit, return that pre-baked response",
